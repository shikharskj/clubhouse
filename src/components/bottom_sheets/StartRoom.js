    ...
    return (
        <>
            ...
            <div className={style.selectRoom}>
                ...
                style.active : ''} onClick={ () => setRoom('open')} 
                >
                    <div>
                        <FcGlobe />
                    </div>
                ...
                <button className={room == 'social' ? 
                style.active : ''} onClick={ () => setRoom('social')}
                >
                    <div>
                        <FcGlobe />
                    </div>
                ...
                <button className={room == 'closed' ? 
                style.active : ''} onClick={ () => setRoom('closed')}
                >
                    <div>
                        <FcGlobe />
                    </div>
